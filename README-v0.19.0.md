# OStim Together v0.19.0 — Core + optional integrations

v0.19.0 is an architectural split.
...
`OStimTogether-v0.19.0-Core-Vortex.zip`
...
`OStimTogether-v0.19.0-FOMOD.zip`
